...
/* Appearance */						
	...
	$options['ttrust_bkg_pattern'] = array( "name" => __('Background Pattern','themetrust'),
						"desc" => __('Upload an image to be used as the background for the home page slideshow area.','themetrust'),
						"id" => "ttrust_bkg_pattern",
						"type" => "upload");
	...
	$options['ttrust_dark_accent_color'] = array( "name" => __('Accent Color is Dark','themetrust'),
						"desc" => __('If your accent color is dark, check this box. White text will be used where applicable.','themetrust'),
						"id" => "ttrust_dark_accent_color",
						"std" => "",
						"type" => "checkbox");	
...
/* Home Page */						
	...
	$options['ttrust_recent_projects_title'] = array( "name" => __('Recent Projects Title','themetrust'),
	...
	$options['ttrust_home_project_count'] = array( "name" => __('Number of Projects to Show','themetrust'),
...
function ttrust_customizer_register($wp_customize) {
	...
	$wp_customize->add_setting( $themename.'[ttrust_bkg_pattern]', array(
		'type' => 'option'
	) );
	
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'ttrust_bkg_pattern', array(
		'label' => $options['ttrust_bkg_pattern']['name'],
		'section' => 'ttrust_appearance',
		'settings' => $themename.'[ttrust_bkg_pattern]'
	) ) );

	$wp_customize->add_setting( $themename.'[ttrust_dark_accent_color]', array(
		'default' => $options['ttrust_dark_accent_color']['std'],
		'type' => 'option'
	) );

	$wp_customize->add_control( 'ttrust_dark_accent_color', array(
		'label' => $options['ttrust_dark_accent_color']['name'],
		'section' => 'ttrust_appearance',
		'settings' => $themename.'[ttrust_dark_accent_color]',
		'type' => $options['ttrust_dark_accent_color']['type']
	) );	
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ttrust_color_accent', array(
	...
	$wp_customize->add_setting( $themename.'[ttrust_recent_projects_title]', array(
		'default' => $options['ttrust_recent_projects_title']['std'],
		'type' => 'option'
	) );
	
	$wp_customize->add_control( 'ttrust_recent_projects_title', array(
		'label' => $options['ttrust_recent_projects_title']['name'],
		'section' => 'ttrust_home_page',
		'settings' => $themename.'[ttrust_recent_projects_title]',
		'type' => 'text'
	) );
	
	$wp_customize->add_setting( $themename.'[ttrust_home_project_count]', array(
		'default' => $options['ttrust_home_project_count']['std'],
		'type' => 'option'
	) );
	
	$wp_customize->add_control( 'ttrust_home_project_count', array(
		'label' => $options['ttrust_home_project_count']['name'],
		'section' => 'ttrust_home_page',
		'settings' => $themename.'[ttrust_home_project_count]',
		'type' => 'text'
	) );
